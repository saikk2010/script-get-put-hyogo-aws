...
#Area = ["4s_1_shinonsen","4s_2_toyooka-yabu","4s_3_koto","4s_4_himeji"]
Area = ["4s_1_shinonsen","4s_2_toyooka-yabu"]
...
while(True):
    ...
    with open("get_image1-2.scp",'w+') as f:
    ...
    str_scp='winscp -script=get_image1-2.scp /privatekey=hyogo_ssh.ppk'
    os.system(str_scp)
